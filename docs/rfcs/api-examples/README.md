# docs: expand end-to-end API examples

## Summary

This proposal will show complete create, list, filter, and error workflows. It is intentionally scoped so the service can
