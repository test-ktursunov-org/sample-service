# feat: propagate request correlation IDs

## Summary

This proposal will accept and return correlation IDs across every HTTP response. It is intentionally scoped so the service can
